...
/// 优化版活动历史页面 - 支持分页和懒加载
class ActivityHistoryPageV2 extends StatefulWidget {
  const ActivityHistoryPageV2({super.key});

  @override
  State<ActivityHistoryPageV2> createState() => _ActivityHistoryPageV2State();
}

class _ActivityHistoryPageV2State extends State<ActivityHistoryPageV2> {
